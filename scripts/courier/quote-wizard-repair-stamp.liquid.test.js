...
describe('quote-wizard repair stamp wiring', () => {
  ...
  it('diagnostic turnaround copy is 3 working days, not 24 hours', () => {
    assert.match(liquid, /Quote in 3 working days/);
    assert.match(liquid, /diagnose within 3 working days/);
