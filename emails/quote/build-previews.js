...
const index = [
  ...
  font,
  "<style>body{font-family:Geist,Arial,sans-serif;color:#171717}h1{font-weight:600;letter-spacing:-1px;font-size:28px;margin:0 0 8px}p{color:#4d4d4d}nav a{color:#171717;margin-right:16px}iframe{width:720px;height:1880px;border:0;background:#fafafa;display:block}</style>",
  "</head><body style=\"padding:32px\">",
  "<h1>Quote email</h1>",
  "<p>Same template. Mail-in repair, courier collection, diagnostic. Working-day clocks, no calendar dates.</p>",
