      ...
      <div className="container hp-hero-grid">
        ...
        <div className="workshop-frame">
          <div className="workshop-caption">
            <span className="live-dot" /> From the workshop
          </div>
          <img className="workshop-photo" src="uploads/workshop-bench.jpg" alt="Stereo microscope board-level repair at the Fitzrovia workshop" />
          <div className="workshop-meta">
            <div className="workshop-meta-label">Microsoldering · Fitzrovia</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="hp-hero hp-hero-v2">
      <div className="container hp-hero-grid">
        <div>
          ...
          <h1>We repair what they can't.</h1>
          <p className="hp-hero-sub">
            When Apple says "logic board, £1,400" we say "backlight IC, £380." Microsoldering is what we do — it's why other repair shops send their tough jobs to us.
          </p>
          <div className="hp-hero-cta-row">
            <a href="#wizard" className="hp-cta hp-cta-primary">
              Get a quote <span className="arrow">→</span>
    ...
    <section className="hp-hero hp-hero-v3">
      <div className="container hp-hero-grid">
        <div>
          ...
          <h1>We repair what they can't.</h1>
          <p className="hp-hero-sub">
            Tell us your model and the symptom — see your price in 60 seconds.
          </p>
        </div>
    ...
    <section className="hp-proof" id="proof">
      <div className="container">
        ...
        <div className="proof-grid">
          <article className="proof-case hp-reveal">
            <div className="proof-case-img">
              <img className="proof-photo" src="uploads/repair-scope.jpg" alt="MacBook logic board under the stereo microscope" />
            ...
            <div className="proof-case-body">
              ...
              <div className="proof-case-numbers">
                ...
                <div className="proof-case-num win">
                  ...
                  <span className="proof-case-num-value">£380</span>
                </div>
                <div className="proof-case-num">
                  <span className="proof-case-num-label">Saving</span>
                  <span className="proof-case-num-value">73%</span>
                </div>
              </div>
              <div className="proof-case-foot">
                <span>Case #2026-0418</span>
                <a href="Repair Case Study.html">Read repair log →</a>
              </div>
            </div>
          </article>

          <article className="proof-case hp-reveal hp-reveal-d1">
            <div className="proof-case-img">
              <img className="proof-photo" src="uploads/repair-boardview.jpg" alt="Board-level diagnosis with multimeter and boardview software" />
            ...
            <div className="proof-case-body">
              ...
              <div className="proof-case-foot">
                ...
                <a href="Repair Case Study.html">Read →</a>
              </div>
            </div>
          </article>

          <article className="proof-case hp-reveal hp-reveal-d2">
            <div className="proof-case-img">
              <img className="proof-photo" src="uploads/repair-teardown.jpg" alt="Opened MacBook with ESD strap during board access" />
