    ...
    <section className="hero-v1">
      <div className="container hero-v1-grid">
        ...
        <div className="hero-v1-wizard" id="wizard">
          <QuoteWizard startDevice="macbook" startFaultId="screen" unknownModelTargetId="identify" />
        </div>
      </div>
    </section>
  );
...
function HeroV2({ reviewCount = 719, rating = 4.8, headerStyle = "merged", showFilters = true, modelFirst = false, quoteInModal = false }) {
  // headerStyle:
    ...
    <section className={"hero-v2 hero-v2-hs-" + headerStyle}>
      ...
      <div className="container">
        ...
        <div className="hero-v2-wizard" id="wizard">
          <QuoteWizard startDevice="macbook" startFaultId="screen" unknownModelTargetId="identify" modelFirst={modelFirst} hideProgressOnQuote={true}
            renderQuote={(props) => quoteInModal
              ? <QuoteModalV7 onClose={() => props.editStep('postcode')}><QuoteTiersV6 {...props} /></QuoteModalV7>
              : <QuoteTiersV6 {...props} />} />
        </div>
      </div>
    </section>
      ...
      <header className="collection-header collection-header-slim">
        <div className="container">
          <nav className="coll-breadcrumb" aria-label="Breadcrumb">
            <a href="iCorrect Homepage.html">Services</a>
            <span className="coll-breadcrumb-sep">›</span>
            <a href="MacBook Repairs.html">MacBook</a>
            <span className="coll-breadcrumb-sep">›</span>
